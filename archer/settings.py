...
MIDDLEWARE_CLASSES = (
    ...
    'archer.middleware.BlockedIpMiddleware'
)
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'archer.context_processors.settings',
                'archer.context_processors.ip_address',
            ],
        },
    },
]
BLOCKED_IPS = ['127.0.0.11']
...
LOGGING = {
    ...
    'handlers': {
        ...
        'default': {
            ...
            'filename': BASE_DIR + '/logs/django_all.log',  # 日志输出文件
        ...
        'request_handler': {
            'level': 'INFO',
            'class': 'logging.handlers.RotatingFileHandler',
            'filename': BASE_DIR + '/logs/django_script.log',
            'maxBytes': 1024 * 1024 * 5,
            'backupCount': 5,
            'formatter': 'standard',
        },
